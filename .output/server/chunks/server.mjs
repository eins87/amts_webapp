import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, readonly, mergeProps, withCtx, createVNode, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "title": "Amido - Always with You" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./business-05229b76.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-278024e6.mjs').then((m) => m.default || m)
  },
  {
    name: "products-multifunction_printers",
    path: "/products/multifunction_printers",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./multifunction_printers-a5fc7fdd.mjs').then((m) => m.default || m)
  },
  {
    name: "products-production_printers",
    path: "/products/production_printers",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./production_printers-644eecbc.mjs').then((m) => m.default || m)
  },
  {
    name: "solutions",
    path: "/solutions",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./solutions-619e036b.mjs').then((m) => m.default || m)
  }
];
...
const globalMiddleware_Dhtf2HOPS3 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const ChevronDownIcon = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$a]]);
const _sfc_main$a = {
  name: "ChevronUpIcon",
  emits: ["click"],
  props: {
...
const ChevronUpIcon = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$9]]);
const _sfc_main$9 = {
...
const ChevronRightIcon = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$8 = {
  name: "PlusThickIcon",
  emits: ["click"],
  props: {
...
const PlusThickIcon = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$7 = {
  name: "MinusThickIcon",
  emits: ["click"],
  props: {
...
const MinusThickIcon = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$6 = {
  name: "ArrowUpIcon",
  emits: ["click"],
  props: {
...
const ArrowUpIcon = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$5 = {
  name: "ArrowRightIcon",
  emits: ["click"],
  props: {
...
const ArrowRightIcon = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$4 = {
...
const CheckCircleIcon = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$3 = {
  name: "SegmentIcon",
  emits: ["click"],
  props: {
...
const SegmentIcon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$2 = {
  name: "CloseIcon",
  emits: ["click"],
  props: {
...
const mdi_sob313MTfs = /* @__PURE__ */ defineNuxtPlugin((NuxtApp) => {
  const components2 = {
    ChevronDownIcon,
    ChevronUpIcon,
    ChevronRightIcon,
...
const runtimeConfig_s9BXXBz0gh = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const config = /* @__PURE__ */ useRuntimeConfig();
...
const _plugins = [
  ...
  router_jmwsqit4Rs,
  plugin_AOuQ1DYzjk,
  globalMiddleware_Dhtf2HOPS3,
  mdi_sob313MTfs,
  runtimeConfig_s9BXXBz0gh,
...
const layouts = {
  default: () => import('./default-137600a6.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen font-sans antialiased relative" }, _attrs))}><div class="relative"><div class="absolute top-0 left-0 w-full h-[94vh] sm:h-[120vh] lg:h-[130vh] cover-gradient-2 sm:cover-gradient"></div>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-f79630e9.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-99c79f4e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useHead as b, createError as c, defineNuxtRouteMiddleware as d, entry$1 as default, navigateTo as n, useRuntimeConfig as u };
